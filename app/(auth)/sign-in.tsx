          ...
          <ScrollView>
            <View className="w-full justify-center h-full px-4 my-6">
              <Image source={colorScheme === 'dark' ? images.logoBlanc : images.logoNoir}
                resizeMode="contain"
                className="w-24 h-24" />
              <Text className="text-2xl text-white mt-10 font-psemibold">Créer un compte Hequs</Text>
              ...
              <View className="justify-center pt-5 flex-row gap-2">
                <Text className="text-lg text-gray-100">Vous n'avez pas de compte ?</Text>
                <Link href='/sign-up' className="text-lg font-psemibold text-secondary">Créer un compte</Link>
              </View>
